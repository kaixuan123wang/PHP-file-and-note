...
<body>
	<div class="all">
		...
		<div class="content">
			...
			<p>
				<input type="radio" name="sel" id="sel" value="太棒了">
				<label for="sel">太棒了</label>
				<input type="radio" name="sel" id="sel" value="很棒">
				<label for="sel">很棒</label>
				<input type="radio" name="sel" id="sel" value="一般般">
				<label for="sel">一般般</label>
				<input type="radio" name="sel" id="sel" value="没玩过">
